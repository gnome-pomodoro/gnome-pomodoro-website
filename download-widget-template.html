{{if linux }}
    ...
    {{if debian && gte(debian, "7") }}
        <section>
            ...
            <footer>
                <p class="contributors">Debian packages are provided by <a href="https://github.com/aerostitch" rel="nofollow">Joseph Herlant</a>.</p>
            </footer>
        </section>
    {{/if}}
    ...
    {{if ubuntu && gte(ubuntu, "14.10") }}
        ...
        <section>
            ...
            <footer>
                <p class="contributors">Ubuntu packages are provided by <a href="https://github.com/aerostitch" rel="nofollow">Joseph Herlant</a>.</p>
            </footer>
        </section>
    {{/if}}
